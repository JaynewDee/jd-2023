...
const ScrollTop = () => {
  return (
    <div>
      <button className="scroll-btn scroll-top-btn" type="button">{ArrowUp({ size: "1rem", color: "white" })}</button>
    </div>
  )
}
...
const ScrollBot = () => {
  return (
    <div>
      <button className="scroll-btn scroll-bottom-btn" type="button">{ArrowDown({ size: "1rem", color: "white" })}</button>
    </div>
  )
}
